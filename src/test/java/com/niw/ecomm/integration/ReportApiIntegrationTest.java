 ...
 *
 * <p>
 * Customers with 2 or fewer orders (Carla Sousa, Daniel Pinto) are excluded
 * by the {@code HAVING COUNT(DISTINCT o.id) > 2} predicate in the repository
...
class ReportApiIntegrationTest {
    ...
    /**
     * Configures REST Assured to target the randomly assigned server port before each test.
     */
    @BeforeEach
    void setUp() {
    ...
    /**
     * Verifies that the top-spenders endpoint returns exactly two customers ranked by
     * total spend in descending order.
     *
     * <p>Expected ranking from seed data:
     * <ol>
     *   <li>Alice Ferreira — 4 orders, €420.00</li>
     *   <li>Bruno Matos    — 3 orders, €290.00</li>
     * </ol>
     *
     * <p>Carla Sousa (2 orders) and Daniel Pinto (1 order) are excluded because the
