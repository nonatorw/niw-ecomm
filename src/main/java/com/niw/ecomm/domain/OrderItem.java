 ...
 *
 * <p>Holds a product reference, quantity, and unit price. The line subtotal is
...
public class OrderItem {
     ...
     *
     * @param productId the identifier of the product being ordered; must not be {@code null}
